...
If you are looking for a laravel implementation do check the following repo [Laravel Implementation](https://github.com/yourdudeken/mpesalaravel)
...
```
3. Check the following example for usage https://github.com/yourdudeken/mpesa/blob/master/example/mpesa.php
...
[Send a quick message here](https://t.me/yourdudeken)

https://t.me/yourdudeken
