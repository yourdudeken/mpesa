...
This directory contains the sandbox environment configuration for the M-Pesa API package.
...
The sandbox environment uses sandbox API credentials configured in `src/config/mpesa.php`.

**Important**: 
- Set `'is_sandbox' => true` in the configuration
- Use sandbox API URL: `https://sandbox.safaricom.co.ke/`
- Use test credentials from [Safaricom Developer Portal](https://developer.safaricom.co.ke/)
- Test phone numbers and credentials are provided by Safaricom for testing
